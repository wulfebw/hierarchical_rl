...
class SequenceReplayMemory(object):
    ...
    def __init__(self, sequence_length, batch_size, capacity=DEFAULT_CAPACITY):
        self.memory = {}
    ...
    def sample_batch(self):
        ...
        # determine shape of states
        state_shape = np.shape(self.memory.values()[0][0])
        states_shape = (self.batch_size,) + (self.sequence_length,) + state_shape
