    ...
    def test_qnetwork_solves_small_mdp(self):
        ...
        def run(learning_rate, freeze_interval, num_hidden, reg):
            ...
            network = recurrent_qnetwork.RecurrentQNetwork(input_shape=(room_size * num_rooms)**2, 
                    sequence_length=1, batch_size=batch_size, num_actions=4, num_hidden=num_hidden, 
                    discount=discount, learning_rate=learning_rate, regularization=reg, 
            ...
            rm = replay_memory.SequenceReplayMemory(sequence_length=1, batch_size=batch_size, capacity=10000)
